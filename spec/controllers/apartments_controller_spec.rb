  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved apartment as @apartment" do
        ...
        post :create, {:apartment => { "name" => "invalid value" }}, valid_session
        assigns(:apartment).should be_a_new(Apartment)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested apartment" do
        ...
        Apartment.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => apartment.to_param, :apartment => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the apartment as @apartment" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Apartment.any_instance.stub(:save).and_return(false)
        put :update, {:id => apartment.to_param, :apartment => { "name" => "invalid value" }}, valid_session
        assigns(:apartment).should eq(apartment)
      end
